...
public class KinesisParticle extends AbstractGameEffect {
    ...
    public KinesisParticle(float sX, float sY, float tX, float tY, boolean facingLeft, Color edge, Color inside) {
